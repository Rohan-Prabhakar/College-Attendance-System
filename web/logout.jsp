<%-- 
    Document   : logout
    Created on : Mar 26, 2021, 1:07:38 PM
    Author     : vijmr
--%>
...
out.println("            </li>");
out.println("            <li class=\"nav-item\">");
out.println("              <a class=\"nav-link\" href=\"vijdhobal.html\">Log-in</a>");
out.println("            </li>");
out.println("            <li class=\"nav-item disabled\" >");
out.println("                <a class=\"nav-link\" href=\"#\" style=\"margin-left: 730px;\">Log-out</a>");
out.println("              </li>");
out.println("                  </div>");
out.println("                  <a class=\"navbar-brand\" href=\"#\" style=\"text-align: end; font-size: 15px;\"\"></a>");
out.println("      ");
out.println("                </nav>");
out.println("      <div class=\"welcome-message\">");
out.println("          <h1 id=\"ssa\" style=\"color: rgb(255, 255, 255); text-align: center; padding-top: 250px; opacity:0;\">Bye!! We hope to see you soon</h1>");
out.println("      </div>");
out.println("    ");
out.println("    </body>");
out.println("    </html>");
