<%-- 
    Document   : Stulog
    Created on : Mar 26, 2021, 2:42:49 AM
    Author     : vijmr
--%>
...
out.println("      ");
out.println("                </nav>");
out.println("        <form action=\"searchStudent\" method=\"post\" style=\"margin-bottom:15px;background-color: #f7f7f7; box-shadow: 0 2px 2px; padding: 30px; box-sizing: border-box; display: block; margin-top: 100px;margin-bottom: 500px; height: 400px; width: 400px; margin-left: 420px;\" >");
...
out.println("                <input type=\"text\" class=\"form-control\" placeholder=\"Enrollment No\" name=\"enroll\" required=\"required\" >");
out.println("            </div>");
out.println("            <div class=\"form-group\">");
