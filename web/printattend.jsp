<%-- 
    Document   : printStu
    Created on : Mar 26, 2021, 2:53:33 AM
    Author     : vijmr
--%>
...
out.println("        ");
out.println("                  </div>");
out.println("                  <a class=\"navbar-brand\" href=\"logout.jsp\" style=\"text-align: end; font-size: 15px;\"\">Log-Out</a>");
out.println("      ");
out.println("                </nav>");
out.println("      <div class=\"welcome-message\">");
out.println("          <h3 id=\"ssa\" style=\"color: rgb(255, 255, 255); text-align: center; padding-top: 250px; opacity: 0;margin-left: 60px;\">Attendance has Successfully Updated!</h3>");
out.println("      </div>");
