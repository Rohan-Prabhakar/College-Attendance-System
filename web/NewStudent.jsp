<%-- 
    Document   : NewStudent
    Created on : Mar 21, 2021, 4:16:16 PM
    Author     : vijmr
--%>
...
out.println("      ");
out.println("                </nav>");
out.println("<form action=\"NewStudent\" method=\"post\" style=\"margin-bottom:15px;background-color:#32383e; box-shadow: 0 2px 2px; padding: 30px; box-sizing: border-box; display: block; margin-top: 100px;margin-bottom: 500px; height: 580px; width: 800px; margin-left: 200px; border-radius: 5px;\" >");
out.println("    <h2 id=\"text-center\" style=\"padding-bottom: 30px; font-size: 60px;color: white;\">Add Student</h2>       ");
...
out.println("        <input type=\"text\" name=\"sem\" class=\"form-control\" placeholder=\"Semester\" required=\"required\" style=\"margin-top:40px;\">");
out.println("    </div>");
out.println("    <div class=\"form-group\" style=\"width: 350px; float:left\">");
out.println("        <input type=\"text\" name=\"course\" class=\"form-control\" placeholder=\"Course\" required=\"required;\">");
out.println("    </div>");
out.println("    <div class=\"form-group\"  style=\"width: 350px; float:right;margin-left: 10px;\">");
out.println("      <input  type=\"text\" name=\"enroll\" class=\"form-control\" placeholder=\"Enrollment-no\" required=\"required\">");
out.println("  </div>");
out.println("    <div class=\"form-group\">");
out.println("        <input type=\"text\" name=\"email\" class=\"form-control\" placeholder=\"Email-Id\" required=\"required\">");
out.println("    </div>");
out.println("    <div class=\"form-group\">");
out.println("        <input  type=\"text\" name=\"father\" class=\"form-control\" placeholder=\"Father's name\" required=\"required\">");
out.println("    </div>");
out.println("    <div class=\"form-group\">");
out.println("        <input  type=\"text\" name=\"mother\" class=\"form-control\" placeholder=\"Mother's name\" required=\"required\">");
out.println("    </div>");
out.println("    <div class=\"form-group\">");
out.println("      <input  type=\"text\" name=\"mobile\" class=\"form-control\" placeholder=\"Mobile-no\" required=\"required\">");
out.println("  </div>");
out.println("  <div class=\"form-group\">");
out.println("    <input  type=\"text\" name=\"add\" class=\"form-control\" placeholder=\"Address\" required=\"required\">");
out.println("</div>");
out.println("    <div class=\"form-group\">");
out.println("        <button type=\"submit\" class=\"btn btn-primary btn-block \" style=\"margin-top:50px; width: 250px; align-self:flex-end; margin-left: 520px;background-color: #563d7c;\">Add</button>");
out.println("    </div>");
out.println("    <div class=\"form-group\">");
out.println("    </div>");
