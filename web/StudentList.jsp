<%-- 
    ...
    Created on : Mar 21, 2021, 4:14:36 PM
    Author     : vijmr
--%>
...
%>
        ...
        <table class="table table-hover table-dark" cellpadding="5" style="font-family: verdana; font-size: 10pt;">
            ...
            <tr>
                ...
                <td><button class="btn btn-primary" style="background-color: #f44336; height:30px;font-size: 12px;" onclick="document.location='DeleteStudent?enroll=<%= rs.getString(1) %>'" >Delete</button> </td>
        ...
        <br>
        <button class="btn btn-primary" style="background-color: #4CAF50; margin-left: 555px;" onclick="document.location='NewStudent.jsp'">New Student</button>
        
        <br>
        <button class="btn btn-primary" style="background-color: #4CAF50; margin-left: 555px;" onclick="document.location='Attendance'">Student Attendance</button>
